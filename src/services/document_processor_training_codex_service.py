...
class BoundedCodexDispatcher:
    ...
    def _prompt(task_json: str) -> str:
        return (
            ...
            "Only the approved PHI-safe project tracker synchronization may access "
            "Smartsheet; never read/write document or correction rows/comments. "
            "Never access mailbox, OCR, Ollama, protected documents, or "
